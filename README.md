...
movies = pd.read_csv(r"/content/movies.dat", sep='::', engine='python', encoding='latin1',names = ['MovieID','Title','Genre'])
ratings = pd.read_csv(r"/content/ratings.dat",sep='::', engine='python',encoding='latin1')
ratings.columns =['UserID', 'MovieID', 'Rating', 'Timestamp']
users = pd.read_csv(r"/content/users.dat",sep='::',engine='python',encoding='latin1')
